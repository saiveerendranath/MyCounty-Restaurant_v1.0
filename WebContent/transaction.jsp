...
<%
PreparedStatement pstmt=con.prepareStatement("select * from transaction where email=?");
...
if(rs.next())
{
	%>
		...
		<%int cost=Integer.parseInt(rs.getString(3));
			double vat=(cost+100)*0.15;
			double total= cost+vat;
			String tableno=rs.getString(2);
        ...
        <div class="row row-content align-items-center">
            <div class="col-8 offset-2">
            	<div class="card">
            		<h2 class="card-header">Reservation Card</h2>
            		<div class="card-body">
            			<dl class="row">
            				<dt class="col-6">E-mail</dt>
            				<dt class="col-6"><%=email%></dt>
            				<dt class="col-6">Food Cost</dt>
            				<dt class="col-6"><%=cost%></dt>
            				<dt class="col-6">Table</dt>
            				<dt class="col-6"><%=tableno%></dt>
            				<dt class="col-6">Reservation Cost</dt>
            				<dt class="col-6">100</dt>
            				<dt class="col-6">VAT</dt>
            				<dt class="col-6"><%=vat%></dt>
            				<dt class="col-6">Total</dt>
            				<dt class="col-6"><%=total%></dt>
            				
            				<dt class="col-3 offset-4"><a href="cancelTransaction.jsp" class="btn btn-color">Cancel</a></dt>
            			</dl>
            		</div>
            	</div>
            </div>
...
else
{
	...
	PreparedStatement pstmt1=con.prepareStatement("insert into transaction values(?,?,?)");
	pstmt1.setString(1,email);
	Random rand=new Random();
	int table=rand.nextInt(6)+1;
	pstmt1.setString(2,"Table-"+table);
	pstmt1.setString(3,pay);
